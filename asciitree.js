...
function main() {
  ...
  if (args.length === 0 || args[0] === '--help' || args[0] === '-h') {
    console.log(`
ASCII Tree Parser - Create directory structures from ASCII tree diagrams

Usage:
  node asciitree.js <input_file> [output_directory]
  
  OR pipe input:
  
  cat tree.txt | node asciitree.js

Examples:
  node asciitree.js tree.txt
  node asciitree.js tree.txt ./projects
  cat tree.txt | node asciitree.js
    `);
    return;
  }
